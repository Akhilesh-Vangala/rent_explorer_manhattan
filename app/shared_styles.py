"""
Shared styles for SmartRent Manhattan Streamlit application.

This module provides centralized CSS styling that is used across all pages
of the Streamlit dashboard to ensure consistent appearance.
"""
...
def apply_shared_styles():
    """
    Apply shared styles to the Streamlit app.
